      ...
      <div className="cf">
        {this.state.recipes
          .filter(function(recipe) {
            ...
            let search =
              _this.props.searchValue.length === 0 ||
              recipe.title
                .toLowerCase()
                .indexOf(_this.props.searchValue.toLowerCase()) > -1 ||
            ...
            let time =
              _this.props.timeValue.length === 0 ||
              Number(recipe.totalTime) <= Number(_this.props.timeValue);
            ...
            for (var key in _this.props.filterValues) {
              let check =
                _this.props.filterValues[key].length === 0 ||
                recipe.labels
                  .toLowerCase()
                  .indexOf(_this.props.filterValues[key]) > -1;
