...
export const meta = {
  ...
  slug: 'this-is-the-europe-i-am-proud-of',
  date: '2015/9/5',
  category: OPINION
}
...
<Blockquote cite="Wahid, a Syrian refugee" align={Blockquote.RIGHT}>“Now we are breathing the air of freedom here.”</Blockquote>
