...
export const meta = {
  ...
  image: {
    ...require('./waves.jpg?resize&sizes[]=400&sizes[]=800&sizes[]=1600&sizes[]=2400'),
    colors: require('./waves.jpg?lqip-colors'),
    alt: 'Waves disturb a dark body of water.'
  },
  date: '2017/4/6',
  category: JOURNAL
}
...
<Blockquote align={Blockquote.FULL}>
...
_PS: The title is a reference to the song [The Sound of Silence](https://www.youtube.com/watch?v=4zLfCnGVeL4) by Simon & Garfunkel. I've been listening to it on repeat._
