...
export const meta = {
  ...
  slug: 'nobody-has-the-intention-of-building-an-airport',
  image: {
    ...require('./nobody-building-airport.jpg?resize&sizes[]=400&sizes[]=800&sizes[]=1600&sizes[]=2400'),
    colors: require('./nobody-building-airport.jpg?lqip-colors'),
...
<Blockquote size={Blockquote.MEGA}>
  {' '}
  *Reference to the famous quote from 1961 by Walter Ulbricht, then head of state
  of the German Democratic Republic: “Nobody has the intention of building a wall!” 
  —  two month later work began on what was to become the <a href="https://en.wikipedia.org/wiki/Berlin_Wall">
    Berlin Wall
  </a>. At the moment workers and politicians struggle to finish the new Berlin Brandenburg
  airport that is supposed to replace the two old airports Tegel & Schönefeld and
  should have started operation over a year ago.
</Blockquote>
