...
description: 'Guess what, it’s a continent. It consists of 55 individual countries, yet western journalists insist on referring to it as one place.'
date: '2015/3/27'
category: 'Opinion'
layout: 'post'
---
...
<Figure
  image={{
    ...require(`./child-eyes.jpg?resize&sizes[]=400&sizes[]=800&sizes[]=1200&sizes[]=2400`),
    colors: require(`./child-eyes.jpg?lqip-colors`),
    alt: 'A young black child looks up from the painting she is drawing.'
  }}
  caption="Yes, this photo was taken in Africa. But it is wrong to reduce ‘Africa’ to big eyes and poverty. There is so much more to the continent and each country is unique."
  align={Figure.LEFT}
/>
